...
/*==================================================================================================
	...
	Supported Game Modes in Left 4 Dead 2
		...
		Team Scavenge
		Mutation 1-20
		Community 1-5cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
###                                                                                  ###
###             Format(g_strCampaignFirstMap[1], 10, "c1m1_hotel");                  ###
###             Format(g_strCampaignLastMap[1], 10, "c1m4_atrium");                  ###
###             Format(g_strCampaignName[1], 10, "Dead Center");                     ###
###                                                                                  ###
...
{	
	...
	Format(g_strCampaignFirstMap[11], 32, "c13m1_alpinecreek");
	...
	Format(g_strCampaignLastMap[11], 32, "c13m4_cutthroatcreek");
	...
	Format(g_strCampaignName[11], 32, "Cold Stream");
