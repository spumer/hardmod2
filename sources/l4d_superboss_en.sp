...
public OnPluginStart()
{
	...
	l4d_superboss_enable = CreateConVar("l4d_superboss_enable", "1", "super boss 0:disable, 1:eanble ", FCVAR_PLUGIN);
 	l4d_superboss_print = CreateConVar("l4d_superboss_print", "0", "print message when superboss spawn , 0:disable, 1:enable", FCVAR_PLUGIN);	
...
{
	if(GameMode==2 || GetConVarInt(l4d_superboss_enable)==0) return Plugin_Continue; 
