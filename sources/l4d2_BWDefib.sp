...
public OnPluginStart()
{
	...
	h_TempHealth = CreateConVar("l4d2_bwdefib_temphealth", "39.0", "Amount of temporary health with which a defibed survivor is brought back.", FCVAR_PLUGIN, true, 0.0, true, 100.0);
